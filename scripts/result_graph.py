...
class Window(QMainWindow):
    ...
    def update(self):
        ...
        self.rewardsPlt.plot(self.ep, self.average_rewards, pen=(255, 255, 0))
        self.save_data([self.ep, self.data])
        self.qValuePlt.plot(self.ep, self.data, pen=(0, 255, 0))
